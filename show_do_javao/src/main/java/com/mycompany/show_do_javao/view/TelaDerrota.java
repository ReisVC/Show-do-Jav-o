...
ImageIcon icon = new ImageIcon(getClass().getResource("/lose.GIF"));
    ...
    public TelaDerrota() {
        ...
        icon.setImage(icon.getImage().getScaledInstance(logo.getWidth(), logo.getHeight(), 3));
        logo.setIcon(icon);
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(10, 21, 116));
        ...
        jPanel1Layout.setVerticalGroup(
            jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addComponent(logo, javax.swing.GroupLayout.PREFERRED_SIZE, 498, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
